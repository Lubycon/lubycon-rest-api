...
">
    <div id="header" style="width: 100%; height: 70px; line-height: 60px; background: #444; text-align: center;">
        <img src="{{URL::asset('/image/logo/header_logo.png')}}" style="width: 20%; min-width: 120px;" align="middle" alt="lubycon-logo-title">
    </div>
    <div id="body" style="padding: 20px; background: #77e4c9; color: #fff;">
        <div class="card" style="text-align: center;">
            <img src="{{URL::asset('/image/logo/logo.png')}}" style="width: 20%; margin: 20px 0;" align="middle" alt="lubycon-logo">
        </div>
        <div class="card" style="text-align: center;">
